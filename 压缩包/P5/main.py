...
if __name__ == "__main__":
    ...
    # Training Relation
    parser.add_argument("--batch_size", default=512, type=int, help="Batch size for training and evaluation.")
    parser.add_argument("--epoch", default=5, type=int, help="The number of training epochs.")
    ...
    parser.add_argument("--lenet", action="store_true",default="True", help="Use LeNet-5 as the model.")
    parser.add_argument("--vgg", action="store_true", help="Use VGG-16 as the model.")
    parser.add_argument("--resnet", action="store_false", help="Use ResNet as the model.")
